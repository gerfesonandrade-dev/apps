...
function detectarCategoria(texto) {
  ...
  if (t.match(/receita|bolo|cozinha|massa/)) return "Receita";
  if (t.match(/cimento|obra|tijolo|parede/)) return "Construção";
  if (t.match(/decoração|sofá|ambiente/)) return "Decoração";
...
<div class="topbar">
  <div class="topbar-inner">
    ...
    <span class="brand">IDEAVAULT</span>
...
app.post("/ideavault/webhook", async (req, res) => {
  ...
  if (msg.text) {
    ...
    if (pend) {
      ...
      await sendMessage(chatId, "✅ Salvo!");
